...
function documentContentToMarkdown(_ref) {
  let {content} = _ref,
    metadata = _objectWithoutProperties(_ref, ["content"])
      ...
      new Promise(async (resolve, reject) => {
        try {
          ...
          const markdown = documentContentToMarkdown(
            _extends({}, metadata, {content})
          )

          const document = _extends({}, metadata, {
            content,
            markdown,
          })
...
exports.sourceNodes = async (
  ...
  let {config} = _ref2,
    options = _objectWithoutProperties(_ref2, ["config"])
